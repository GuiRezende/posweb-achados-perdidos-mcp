...
public class OcorrenciaService {
    ...
    public Optional<OcorrenciaDTO> getOcorrenciaByObjetoId(Long id) {
        return repository.findByObjetoId(id)
                .map(mapper::toDTO);
    }

    public OcorrenciaDTO insert(OcorrenciaDTO ocorrencia) {
        ...
        return mapper.toDTO(repository.save(mapper.toEntity(ocorrencia)));
    }
}
